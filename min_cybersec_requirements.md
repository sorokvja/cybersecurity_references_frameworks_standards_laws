## [Minimālās kiberdrošības prasības - Ministru kabineta noteikumi Nr. 397](https://likumi.lv/ta/id/361481-minimalas-kiberdrosibas-prasibas)
> "minimālās kiberdrošības prasības būtisko pakalpojumu sniedzējiem, svarīgo pakalpojumu sniedzējiem un informācijas un komunikācijas tehnoloģiju (turpmāk – IKT) kritiskās infrastruktūras īpašniekiem vai tiesiskajiem valdītājiem (turpmāk kopā – subjekti, katrs atsevišķi – subjekts)" [^1]

### 3.2. Kiberdrošības pārvaldības dokumentācija
| Atsauce | Prasība | Subjekts (ja ir norāde) | Komentāri |
|---------|---------|-------------------------|-----------|
| 21.1. | kiberdrošības politika ir izstrādāta
| 21.2., 30. | IKT resursu un informācijas sistēmu katalogs - uzskaita visus īpašumā un valdījumā esošos IKT resursus un informācijas sistēmas, kas pakļauti kiberriskiem
| 21.3., 39. | kiberrisku pārvaldības un IKT darbības nepārtrauktības plāns - var izstrādāt vairākus kiberrisku pārvaldības un IKT darbības nepārtrauktības plānus atbilstoši subjekta darbības specifikai (piemēram, valsts informācijas sistēmai, subjekta datu centram). Šādā gadījumā par kiberrisku pārvaldības un IKT darbības nepārtrauktības plānu uzskatāms šo plānu kopums
| 21.4., 47. | kiberincidentu žurnāls - uztur kiberincidentu žurnālu, kurā reģistrē ziņas par subjekta īpašumā un valdījumā esošajos tīklos un informācijas sistēmās konstatētajiem kiberincidentiem
| 23. | kiberdrošības pārvaldības dokumentu kopuma daļas ir pieejamas tikai personām, kurām tās nepieciešamas darba pienākumu vai ārpakalpojuma izpildei
| 24. | kiberdrošības pārvaldības dokumentu kopumu veido un uztur arī elektroniskā formātā 
| 25. | kiberdrošības pārvaldības dokumentu kopumā ietilpstošo dokumentu kopijas tiek uzglabātas atsevišķi no oriģināliem un ir pieejamas gadījumā, ja dokumentu oriģināli nav pieejami (piemēram, datu nesēja bojājuma gadījumā).
| 26.1. | pēc šo noteikumu 21.1. un 21.3. apakšpunktā noteikto kiberdrošības pārvaldības dokumentu kopuma daļu apstiprināšanas vai aktualizēšanas nekavējoties, bet ne vēlāk kā viena mēneša laikā tās iesniedz Satversmes aizsardzības birojam | K 
| 26.2. | šo noteikumu 21.2. un 21.4. apakšpunktā minētā kiberdrošības pārvaldības dokumentu kopuma daļas iesniedz Satversmes aizsardzības birojam kopā ar pašvērtējuma ziņojumu atbilstoši šo noteikumu 8.3. apakšnodaļai | K
| 26.3. | pēc citu šo noteikumu 21. punktā nenorādītu kiberdrošības dokumentu apstiprināšanas vai aktualizēšanas nekavējoties, bet ne vēlāk kā viena mēneša laikā tos iesniedz Satversmes aizsardzības birojam | K

### 3.3. Kiberdrošības politika
| Atsauce | Prasība | Subjekts (ja ir norāde) | Komentāri |
|---------|---------|-------------------------|-----------|
| 28. | regulāri, bet ne retāk kā reizi trijos gados pārskata un nepieciešamības gadījumā aktualizē kiberdrošības politiku
...
| 29.5. | informāciju par [Nacionālās kiberdrošības likuma](https://likumi.lv/ta/id/353390-nacionalas-kiberdrosibas-likums), šo noteikumu un citu subjektam saistošo normatīvo aktu, standartu un sertifikācijas shēmu prasībām kiberdrošības jomā, kuras attiecas uz subjekta īpašumā un valdījumā esošajiem IKT resursiem un informācijas sistēmām.

### 3.4. IKT resursu un informācijas sistēmu katalogs
| Atsauce | Prasība | Subjekts (ja ir norāde) | Komentāri |
|---------|---------|-------------------------|-----------|
| 31. | uztur, pārskata un izmaiņu gadījumā nekavējoties, bet ne vēlāk kā viena mēneša laikā aktualizē IKT resursu un informācijas sistēmu katalogu.
| 32. | nosaka konfidencialitātes, integritātes un pieejamības drošības klasi (A[^2], B[^3] vai C[^4]) atbilstoši šo noteikumu [5. pielikumā](https://likumi.lv/ta/id/361481-minimalas-kiberdrosibas-prasibas#piel5) ietvertajai metodikai katrai subjekta īpašumā un valdījumā esošajai informācijas sistēmai un informācijas resursu kategorijai[^5].
...
| 40.1. | IKT kritiskās infrastruktūras īpašnieks vai tiesiskais valdītājs un būtisko pakalpojumu sniedzējs, kura īpašumā vai valdījumā ir vismaz viena A klases informācijas sistēma, – vismaz reizi gadā; | K, B 
| 40.2. | būtisko pakalpojumu sniedzējs, kura īpašumā vai valdījumā nav A klases informācijas sistēmas, – vismaz reizi divos gados; | B
| 40.3. | svarīgo pakalpojumu sniedzējs – vismaz reizi trijos gados | S
...
| 43. | Subjekta kiberdrošības pārvaldnieks nodrošina kiberrisku pārvaldības un IKT darbības nepārtrauktības plāna izpildes uzraudzību un kontroli. 
| 43. | Ja IKT kritiskās infrastruktūras īpašnieka vai tiesiskā valdītāja kiberdrošības pārvaldnieks ir vienlaikus atbildīgs arī par kiberrisku pārvaldības un IKT darbības nepārtrauktības plāna izstrādi, pārskatīšanu un aktualizēšanu, tad konkrētā IKT kritiskās infrastruktūras īpašnieka vai tiesiskā valdītāja vadītājs nodrošina kiberrisku pārvaldības un IKT darbības nepārtrauktības plāna izpildes uzraudzību un kontroli. | K
...
| 45. | IKT kritiskās infrastruktūras īpašnieks vai tiesiskais valdītājs: | K
| 45.1. | nosaka atbildīgo personu par kiberrisku pārvaldības un IKT darbības nepārtrauktības plāna izstrādi, pārskatīšanu un aktualizēšanu, kā arī par plānā ietverto pasākumu īstenošanu | K
| 45.2. | nekavējoties, bet ne vēlāk kā piecu darbdienu laikā pēc šo noteikumu 45.1. apakšpunktā minētās personas noteikšanas par to informē Satversmes aizsardzības biroju | K

### 3.6. Kiberincidentu pārvaldība un kiberincidentu žurnāls
| Atsauce | Prasība | Subjekts (ja ir norāde) | Komentāri |
|---------|---------|-------------------------|-----------|
| 46. | ievieš pārvaldības procesus, lai identificētu kiberincidentus[^6], gandrīz notikušus kiberincidentus[^7] un ievainojamības[^8], kā arī lai risinātu un novērstu kiberincidentus un ievainojamības, nosakot vismaz: 
...
| 47. | Subjekts nodrošina ziņu reģistrēšanu žurnālā ne vēlāk kā 24 stundu laikā no kiberincidenta konstatēšanas brīža vai pēc jebkādām izmaiņām iepriekš žurnālā norādītajās ziņās
...
| 48.2. | kiberincidenta veida kodu vai kodus atbilstoši šo noteikumu [7. pielikumā](https://likumi.lv/ta/id/361481-minimalas-kiberdrosibas-prasibas#piel7) ietvertajai tipoloģijai 
...
[^1]: Subjekti: (B) būtisko pakalpojumu sniedzējs - [Nacionālās kiberdrošības likums, 20. pants.](https://likumi.lv/ta/id/353390#p20), (S) svarīgo pakalpojumu sniedzējs - [Nacionālās kiberdrošības likums, 21. pants.](https://likumi.lv/ta/id/353390#p21), (K) Informācijas un komunikācijas tehnoloģiju kritiskā infrastruktūra - [Nacionālās kiberdrošības likums, 24. pants.](https://likumi.lv/ta/id/353390#p24)
[^2]: A klases (paaugstinātas drošības) informācijas sistēmu, ja tai ir noteikta vismaz viena A konfidencialitātes, integritātes vai pieejamības drošības klase
[^3]: B klases (pamata drošības) informācijas sistēmu, ja tai ir noteikta vismaz viena B konfidencialitātes, integritātes vai pieejamības drošības klase, bet nav noteikta neviena A konfidencialitātes, integritātes vai pieejamības drošības klase
[^4]: C klases (minimālās drošības) informācijas sistēmu, ja tai ir noteiktas tikai C konfidencialitātes, integritātes un pieejamības drošības klases
[^5]: Kritiskās infrastruktūras kopumā iekļautu informācijas sistēmu uzskata par A klases informācijas sistēmu, nepiemērojot šo noteikumu 32. un 33. punktā minēto kārtību - [skat. punktus 34. - 38.](https://likumi.lv/ta/id/361481#p34)
